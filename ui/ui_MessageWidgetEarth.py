...
class Ui_MessageWidget(object):
    ...
    def retranslateUi(self, MessageWidget):
        ...
        self.enterButton.setText(QtCore.QCoreApplication.translate("MessageWidget", "进入", None))
        self.exitButton.setText(QtCore.QCoreApplication.translate("MessageWidget", "返回地图", None))
