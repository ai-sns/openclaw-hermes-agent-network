...
class MapTaskList(QTreeWidget):
    ...
    def __init__(self, parent, agent):
        ...
        super(MapTaskList, self).__init__(parent)
    ...
    def keyPressEvent(self, event):
        if event.key() == Qt.Key_Delete:
            ...
            super(MapTaskList, self).keyPressEvent(event)
    ...
    def on_itemDoubleClicked(self, item, column):
        ...
        task_record = query_single_map_task(id=id_value)
