...
def get_user_ask_msg_title_formatted(page_index, createtime=None,show_checkbox="none",checked=""):
    ...
    message = f"""<div style='display:inline' id="msg_div_{page_index}" data-value="{page_index}v" data-text="{page_index}t" data-index="{page_index}i"  onmouseover='handleMouseOver(this)'
         onmouseleave='handleMouseLeave(event)'><input  class="styled-checkbox" style="display:{show_checkbox}" {checked}  type="checkbox" id="msg_checkbox_{page_index}" data-value="{page_index}" onclick="add_to_selected_msg(this,'question')"><strong><em><span style='color: darkred;font-size:14px;'>用户: </span><span style='color: #c0c0c0; font-size:14px;'>{createtime.strftime("%Y-%m-%d %H:%M:%S")}&nbsp;&nbsp;</span></em></strong>
        </div>
        """
...
def get_agent_reply_msg_title_formatted(model_name, page_index, createtime=None, show_loading=True,show_checkbox="none",checked=""):
