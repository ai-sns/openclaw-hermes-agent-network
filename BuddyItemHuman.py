...
from MessageBoxHuman import MessageBoxHuman
from AddBuddyDialog import AddBuddyDialog

from jabber import STATUS
from jabber import STATUS_IMAGE

class BuddyItemHuman(QTreeWidgetItem):
    """
      BuddyItemHuman implements the view of a Buddy from the Roster
    """
    ...
    def __init__(self, parent, jid, con,mainwindow):
        super(BuddyItemHuman, self).__init__(parent, [jid], QTreeWidgetItem.UserType + 1)
    ...
    def createDialog(self):
        ...
        if not self.dialog:
            ...
            self.msg = MessageBoxHuman(self.dialog, self.connectionThread, self.jid, self.name)
