...
def main():
    ...
    user_proxy.initiate_chat(assistant, message="介绍一下北京?")
...
class RichIOStream(IOStream):
    ...
    def print(self, *args: Any, **kwargs) -> None:
        ...
        print("cjr in the rich:"+self.prefix_str)
...
def set_custom_IO_overrides():
    # IOStream.set_default(RichIOStream())
    IOStream.set_global_default(RichIOStream("我是参数"))
