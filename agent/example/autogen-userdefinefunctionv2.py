...
# executor = LocalCommandLineCodeExecutor(work_dir=work_dir, functions=[add_two_numbers, load_data])#functions=[add_two_numbers, load_data]这个参数主要是用来生成提示词
executor = LocalCommandLineCodeExecutor(work_dir=work_dir)#functions=[add_two_numbers, load_data]这个参数主要是用来生成提示词
#
# '''
# exec(exec_code)
