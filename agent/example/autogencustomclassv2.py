...
class CustomOpenAIClient:
    ...
    def __init__(self, config: Dict[str, Any]):
        ...
        anthropic_kwargs = set(inspect.getfullargspec(OpenAI.__init__).kwonlyargs)
...
config_list_claude = [
    {
        ...
        "stream":True,
        # "api_type": "ChatGLM",
        "model_client_cls": "OpenAICompatibleLLMClient",
    }
]
...
assistant.register_model_client(model_client_cls=OpenAICompatibleLLMClient)

reply = assistant.generate_reply(messages=[{"content": "我让你介绍一下惠州", "role": "user"}])
