...
#OpenAI兼容模型
class OpenAICustomizeV2LLMClient:
    ...
    def create(self, params: Dict[str, Any]) -> ChatCompletion:
        ...
        if params.get("stream", False) and "messages" in params:
            ...
            for l_chunk in llm_client.generate_stream(params):
                ...
                if chunk.choices:
                    for choice in chunk.choices:
                        ...
                        finish_reasons[choice.index - 1] = (
                            choice.finish_reason if (hasattr(choice, "finish_reason") and choice.finish_reason !="" and choice.finish_reason !="normal") else "stop"
                        )
