...
import json
import re
from typing import Any, AsyncIterator, Iterator,Dict, List, Optional, Tuple, TypeVar, Union
...
class OpenAIApdater(object):
    ...
    def __init__(
        ...
        model_mapping: Dict[str, str] = {
            ...
            r"ERNIE-3.5-8K": "ERNIE-3.5-8K",
            r"ERNIE-4.0-8K": "ERNIE-4.0-8K",
            r"ERNIE-Lite-8K": "ERNIE-Lite-8K",
    ...
    def chat(
    ...
    ) -> Union[OpenAIResponse, Iterator[OpenAIResponse]]:
        """
        Chat Wrapper API
        """
        ...
        res =self._chat_client.do(**qianfan_request)
    ...
    def _chat_stream(
        ...
        def task(n: int) -> Iterator[Tuple[int, QfResponse]]:
            res_stream = self._chat_client.do(**qianfan_request)
            assert isinstance(res_stream, Iterator)
