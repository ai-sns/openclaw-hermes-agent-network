...
class XmppMixin:
    ...
    def _save_message_to_database(self, content, to_jid, to_name):
        ...
        try:
            ...
            owner_account = (getattr(self.aisns_cfg, "account", "") or "").strip()
            owner_name = getattr(self.aisns_cfg, "name", "") or owner_account
    ...
    def _update_ui_with_sent_message(self, to_jid, content):
        ...
        try:
            self.send_talk_message(self.aisns_cfg.account, to_jid, content)
