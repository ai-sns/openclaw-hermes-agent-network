...
class ui_OpenAIConnectionDialog(object):
    def setupUi(self, ConnectionDialog):
        ...
        # secret_id
        self.secret_id_label = QLabel("secret_id:")
        self.gridlayout.addWidget(self.secret_id_label, 0, 0)
        self.secret_id_edit = QLineEdit()
        self.gridlayout.addWidget(self.secret_id_edit, 0, 1, 1, 2)

        # secret_key
        self.secret_key_label = QLabel("secret_key:")
        self.gridlayout.addWidget(self.secret_key_label, 1, 0)
        self.secret_key_edit = QLineEdit()
        self.secret_key_edit.setEnabled(True)  # Make it editable by default
        self.gridlayout.addWidget(self.secret_key_edit, 1, 1, 1, 2)

        # Model selection
        self.model_label = QLabel("Model:")
        self.gridlayout.addWidget(self.model_label, 2, 0)
        self.model_combobox = QComboBox()
        self.model_combobox.addItems(["hunyuan-lite","hunyuan-standard", "hunyuan-standard-256K", "hunyuan-pro"])
    ...
    def retranslateUi(self, ConnectionDialog):
        ...
        self.secret_id_label.setText("secret_id:")
        self.secret_key_label.setText("secret_key:")
