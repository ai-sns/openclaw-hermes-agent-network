...
class ui_OpenAIConnectionDialog(object):
    def setupUi(self, ConnectionDialog):
        ...
        # qianfan_ak
        self.qianfan_ak_label = QLabel("qianfan_ak:")
        self.gridlayout.addWidget(self.qianfan_ak_label, 0, 0)
        self.qianfan_ak_edit = QLineEdit()
        self.gridlayout.addWidget(self.qianfan_ak_edit, 0, 1, 1, 2)

        # qianfan_sk
        self.qianfan_sk_label = QLabel("qianfan_sk:")
        self.gridlayout.addWidget(self.qianfan_sk_label, 1, 0)
        self.qianfan_sk_edit = QLineEdit()
        self.qianfan_sk_edit.setEnabled(True)  # Make it editable by default
        self.gridlayout.addWidget(self.qianfan_sk_edit, 1, 1, 1, 2)

        # Model selection
        self.model_label = QLabel("Model:")
        self.gridlayout.addWidget(self.model_label, 2, 0)
        self.model_combobox = QComboBox()
        self.model_combobox.addItems(["ERNIE-Tiny-8K", "ERNIE-Lite-8K", "ERNIE-Speed-8K", "ERNIE-Speed-128k", "ERNIE-3.5-8K", "ERNIE-3.5-128K", "ERNIE-4.0-8K"])
    ...
    def retranslateUi(self, ConnectionDialog):
        ...
        self.qianfan_ak_label.setText("qianfan_ak:")
        self.qianfan_sk_label.setText("qianfan_sk:")
    ...
    def toggle_parameters_edit(self, state):
        ...
        # self.qianfan_sk_edit.setEnabled(not enabled)
