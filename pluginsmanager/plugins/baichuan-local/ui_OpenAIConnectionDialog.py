...
class ui_OpenAIConnectionDialog(object):
    def setupUi(self, ConnectionDialog):
        ...
        self.model_combobox.addItems(["baichuan-inc/Baichuan-7B-Chat", "baichuan-inc/Baichuan-13B-Chat", "baichuan-inc/Baichuan2-7B-Chat","baichuan-inc/Baichuan2-13B-Chat"])
