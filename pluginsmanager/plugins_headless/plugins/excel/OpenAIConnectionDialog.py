...
sys.path.append("../../../..")
sys.path.append("../../../../..")
from db.DBFactory import update_PluginMng
...
class OpenAIConnectionDialog(QDialog, ui_OpenAIConnectionDialog):
    ...
    def __init__(self, parent=None):
        ...
        super(OpenAIConnectionDialog, self).__init__()
        self.setupUi(self)
    ...
    def readSettings(self):
        try:
            ...
            with open(file_path, "r") as f:
                ...
                self.url_edit.setText(config.get("url", "https://api.openai.com/v1/chat/completions"))
