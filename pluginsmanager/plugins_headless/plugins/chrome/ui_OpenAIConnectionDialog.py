...
class ui_OpenAIConnectionDialog(object):
    def setupUi(self, ConnectionDialog):
        ...
        ConnectionDialog.resize(600, 600)

        self.vboxlayout = QVBoxLayout(ConnectionDialog)
        self.vboxlayout.setObjectName("vboxlayout")

        # Group box for API configuration
        self.groupbox_basic = QGroupBox(ConnectionDialog)
        self.groupbox_basic.setObjectName("groupbox_basic")
        self.gridlayout_basic = QGridLayout(self.groupbox_basic)
        self.gridlayout_basic.setObjectName("gridlayout_basic")
        self.vboxlayout.addWidget(self.groupbox_basic)


        # instruction
        self.instruction_label = QLabel("调用指令:")
        ...
        self.gridlayout_basic.addWidget(self.description_label, 2, 0)
        ...
        self.model_combobox.addItems(["gpt-3.5-turbo","gpt-3.5-turbo-instruct","gpt-4", "gpt-4-32k", "gpt-4-turbo","gpt-4o-mini", "gpt-4o"])
        ...
        self.gridlayout.addWidget(self.custom_params_label, 9, 0)
        self.custom_params_checkbox = QCheckBox()
        self.gridlayout.addWidget(self.custom_params_checkbox, 9, 1, 1, 2)
        self.custom_params_checkbox.setEnabled(True)  # Enable by default

        # Parameters text edit
        self.parameters_textedit = QTextEdit()
        self.gridlayout.addWidget(self.parameters_textedit, 10, 0, 1, 3)
        ...
        ConnectionDialog.setWindowTitle("插件配置")
    ...
    def retranslateUi(self, ConnectionDialog):
        self.groupbox_basic.setTitle("基本配置")
        self.groupBox.setTitle("连接配置")
        ...
        self.description_label.setText("功能描述:")
